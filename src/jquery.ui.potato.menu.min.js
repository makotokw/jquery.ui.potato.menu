...
function(e){$menuGroup.fadeOut(option.hideDuration)})});$menu.find('a[href^="#"]').click(function(){$menuGroups.fadeOut(option.hideDuration);return $(this).attr("href")!="#"});return this}$.fn.extend({ptMenu:menu})})(jQuery);